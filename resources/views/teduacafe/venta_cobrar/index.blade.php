...
<div class="container-fluid">     
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ventas por cobrar</h1>
    </div>
                    ...
                    @if($ventaa)
                        ...
                        <tbody>
                            <tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('ventapendiente.destroy', $venta->idventa)}}" method="post">
                                                {{csrf_field()}}
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('ventapendiente.update', $venta->idventa)}}" method="post">
                                                {{csrf_field()}}
                                            
                                                    
                                                    <div class="col-md-8">
                                                    <select class="custom-select" name="idmesa">
                                                        <?php
                                                            $mesas = \App\Mesa::all();
                                                        ?>
                                                        @foreach($mesas as $mesa)
                                                        @if($mesa->id != $venta->idmesa)
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('ventacompleta.store')}}" method="post">
                                                {{csrf_field()}}
                                ...
                                <a type="button" data-toggle="modal" data-target="#exampleModal-{{ $venta->id }}"class="btn-sm btn btn-primary " style="    margin: 0em 0.2em 0em 0.2em;">Cambiar mesa</a>
