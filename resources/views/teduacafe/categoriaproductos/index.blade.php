...
<div class="container-fluid">     
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Categorias de productos</h1>
        <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="{{ route('categoriaproductos.register') }}"><i
                                ...
                                <div class="modal fade" id="exampleModal1-{{$categoria->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModal1Label" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('categoriaproductos.update', $categoria->id) }}"  role="form">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{route('categoriaproductos.destroy', $categoria->id)}}" method="post">
                                                {{csrf_field()}}
