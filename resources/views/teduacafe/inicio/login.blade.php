                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4" style="color: white !important;">Bienvenido a {{\App\Configuracioncafe::all()->first()->titulo_sistema}}</h1>
                                    </div>
                                    

                                    <form class="user" method="POST" action="{{ route('cafe.loginn') }}">
                                        {{ csrf_field() }}
