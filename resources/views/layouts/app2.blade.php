...
<div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}">
                @guest
                <div class="sidebar-brand-text mx-3 text-uppercase">{{\App\Configuracion::first()->titulo_sistema}}</div>
                @else
                <div class="sidebar-brand-text mx-3 text-uppercase">{{\App\Configuracion::first()->titulo_sistema}}</div>
                @endguest
            </a>
            ...
            @endif
            <li class="nav-item">
                <a class="nav-link" href="{{ route('rentar_habitacion') }}">
                    <i class="fas fa-cube"></i>
                    <span>Rentar Habitación</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('ventasp.index')}}">
                    <i class="fas fa-dollar-sign"></i>
                    <span>Vender productos</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTw" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('rentas.show')}}">Rentas</a>
                        <a class="collapse-item" href="{{ route('tipohabitacion.index') }}">Tipo de Habitaciones</a>
                        <a class="collapse-item" href="{{ route('habitaciones.index') }}">Habitaciones</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('categoriasp.index')}}">Categorias de Productos</a>
                        @endif
                        <a class="collapse-item" href="{{route('productos.inventario')}}">Inventario</a>
                        <a class="collapse-item" href="{{route('productos.abastecimiento')}}">Abastecer Inventario</a>
                        @if(\App\User::find(Auth::id())->idrole == 1)
                        <a class="collapse-item" href="{{route('ventas.index')}}">Ventas</a>
                        <a class="collapse-item" href="{{route('compras.index')}}">Abastecimientos</a>
                        @endif
                    </div>
                </div>
            </li>
